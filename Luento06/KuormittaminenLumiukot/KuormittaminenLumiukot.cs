...
namespace KuormittaminenLumiukot;
...
/// 
/// </summary>
public class KuormittaminenLumiukot : PhysicsGame
{
    /// <summary>
    /// Tee yksi pallo
    /// </summary>
    ...
    public void TeeLumiukko()
    {
        ...
        TeeLumiukko(x, y, vari);
    }
    
    public void TeeLumiukko(double x, double y)
    {
        TeeLumiukko(x, y, Color.Fuchsia);
    }
